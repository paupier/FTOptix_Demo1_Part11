...
public class EmailSenderLogic : BaseNetLogic
{
    ...
    [ExportMethod]
    public void SendEmail(string mailToAddress, string mailToAddress2, string mailToAddress3, string mailCcAddress1, string mailCcAddress2, string mailCcAddress3, string mailSubject, string mailBody)
    {
        ...
        var fromAddress = new MailAddress(senderAddress, "FTOptix Notifier");
        var toAddress = new MailAddress(mailToAddress, "User1");
        
        var toAddress2 = new MailAddress("Xyz@Email.com", "Dummy");
        var toAddress3 = new MailAddress("Xyz@Email.com", "Dummy");
        var ccAddress1 = new MailAddress("Xyz@Email.com", "Dummy");
        var ccAddress2 = new MailAddress("Xyz@Email.com", "Dummy");
        var ccAddress3 = new MailAddress("Xyz@Email.com", "Dummy");

        if (!string.IsNullOrEmpty(mailToAddress2))
        {
            toAddress2 = new MailAddress(mailToAddress2, "User2");
        }
        if (!string.IsNullOrEmpty(mailToAddress3))
        {
            toAddress3 = new MailAddress(mailToAddress3, "User3");
        }
        if (!string.IsNullOrEmpty(mailCcAddress1))
        {
            ccAddress1 = new MailAddress(mailCcAddress1, "User4");
        }
        if (!string.IsNullOrEmpty(mailCcAddress2))
        {
            ccAddress2 = new MailAddress(mailCcAddress2, "User5");
        }
        if (!string.IsNullOrEmpty(mailCcAddress3))
        {
            ccAddress3 = new MailAddress(mailCcAddress3, "User6");
        }
        ...
        var message = CreateEmailMessage(fromAddress, toAddress, toAddress2, toAddress3, ccAddress1, ccAddress2, ccAddress3, mailBody, mailSubject);
        TrySendEmail(message);
    }

    private MailMessageWithRetries CreateEmailMessage(MailAddress fromAddress, MailAddress toAddress, MailAddress toAddress2, MailAddress toAddress3, MailAddress ccAddress1, MailAddress ccAddress2, MailAddress ccAddress3, string mailBody, string mailSubject)
    {
        ...
        var attachment2 = GetVariableValue("Attachment2").Value;
        var attachment3 = GetVariableValue("Attachment3").Value;
        ...
        {
            var attachmentUri2 = new ResourceUri(attachment2);
            mailMessage.Attachments.Add(new Attachment(attachmentUri2.Uri));
        }
        if (!string.IsNullOrEmpty(attachment3))
        {
            var attachmentUri3 = new ResourceUri(attachment3);
            mailMessage.Attachments.Add(new Attachment(attachmentUri3.Uri));
        }

        mailMessage.ReplyToList.Add(toAddress);
        if (toAddress2.Address != "Xyz@Email.com")
        {
            mailMessage.To.Add(toAddress2);
        }
        if (toAddress3.Address != "Xyz@Email.com")
        {
            mailMessage.To.Add(toAddress3);
        }
        if (ccAddress1.Address != "Xyz@Email.com")
        {
            mailMessage.CC.Add(ccAddress1);
        }
        if (ccAddress2.Address != "Xyz@Email.com")
        {
            mailMessage.CC.Add(ccAddress2);
        }
        if (ccAddress3.Address != "Xyz@Email.com")
        {
            mailMessage.CC.Add(ccAddress3);
        }
